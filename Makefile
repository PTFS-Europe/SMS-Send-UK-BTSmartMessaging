# This Makefile is for the SMS::Send::UK::BTSmartMessaging extension to perl.
#
...
#     AUTHOR => [q[Andrew Isherwood <andrew.isherwood@ptfs-europe.com>]]
#     BUILD_REQUIRES => {  }
#     CONFIGURE_REQUIRES => {  }
#     LICENSE => q[perl]
#     NAME => q[SMS::Send::UK::BTSmartMessaging]
#     PL_FILES => {  }
#     PREREQ_PM => { LWP::UserAgent=>q[0], MIME::Base64=>q[0], SMS::Send::Driver=>q[0], Test::More=>q[0] }
#     TEST_REQUIRES => {  }
#     VERSION_FROM => q[lib/SMS/Send/UK/BTSmartMessaging.pm]
#     clean => { FILES=>q[SMS-Send-UK-BTSmartMessaging-*] }
...
DIRFILESEP = /
DFSEP = $(DIRFILESEP)
NAME = SMS::Send::UK::BTSmartMessaging
NAME_SYM = SMS_Send_UK_BTSmartMessaging
VERSION = 0.0.1
...
MAKE = make
FULLEXT = SMS/Send/UK/BTSmartMessaging
BASEEXT = BTSmartMessaging
PARENT_NAME = SMS::Send::UK
DLBASE = $(BASEEXT)
VERSION_FROM = lib/SMS/Send/UK/BTSmartMessaging.pm
OBJECT = 
LDFROM = $(OBJECT)
LINKTYPE = dynamic
BOOTDEP = 
...
H_FILES  = 
MAN1PODS = 
MAN3PODS = lib/SMS/Send/UK/BTSmartMessaging.pm

# Where is the Config information that we are using/depend on
CONFIGDEP = $(PERL_ARCHLIBDEP)$(DFSEP)Config.pm $(PERL_INCDEP)$(DFSEP)config.h

# Where to build things
INST_LIBDIR      = $(INST_LIB)/SMS/Send/UK
INST_ARCHLIBDIR  = $(INST_ARCHLIB)/SMS/Send/UK
...
TO_INST_PM = lib/SMS/Send/UK/BTSmartMessaging.pm

PM_TO_BLIB = lib/SMS/Send/UK/BTSmartMessaging.pm \
	blib/lib/SMS/Send/UK/BTSmartMessaging.pm
...
DISTNAME = SMS-Send-UK-BTSmartMessaging
DISTVNAME = SMS-Send-UK-BTSmartMessaging-0.0.1
...
manifypods : pure_all  \
	lib/SMS/Send/UK/BTSmartMessaging.pm
	$(NOECHO) $(POD2MAN) --section=$(MAN3EXT) --perm_rw=$(PERM_RW) -u \
	  lib/SMS/Send/UK/BTSmartMessaging.pm $(INST_MAN3DIR)/SMS::Send::UK::BTSmartMessaging.$(MAN3EXT) 
...
clean :: clean_subdirs
	- $(RM_F) \
	  ...
	  *perl.core MYMETA.json \
	  ...
	  tmon.out 
	- $(RM_RF) \
	  SMS-Send-UK-BTSmartMessaging-* blib 
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) '  - '\''Andrew Isherwood <andrew.isherwood@ptfs-europe.com>'\''' >> META_new.yml
	...
	$(NOECHO) $(ECHO) 'name: SMS-Send-UK-BTSmartMessaging' >> META_new.yml
	...
	$(NOECHO) $(ECHO) '  SMS::Send::Driver: '\''0'\''' >> META_new.yml
	...
	$(NOECHO) $(ECHO) '      "Andrew Isherwood <andrew.isherwood@ptfs-europe.com>"' >> META_new.json
	$(NOECHO) $(ECHO) '   ],' >> META_new.json
	...
	$(NOECHO) $(ECHO) '   },' >> META_new.json
	$(NOECHO) $(ECHO) '   "name" : "SMS-Send-UK-BTSmartMessaging",' >> META_new.json
	...
	$(NOECHO) $(ECHO) '            "SMS::Send::Driver" : "0",' >> META_new.json
...
ppd :
	...
	$(NOECHO) $(ECHO) '    <AUTHOR>Andrew Isherwood &lt;andrew.isherwood@ptfs-europe.com&gt;</AUTHOR>' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '    <IMPLEMENTATION>' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '        <REQUIRE NAME="LWP::UserAgent" />' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '        <REQUIRE NAME="MIME::Base64" />' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '        <REQUIRE NAME="SMS::Send::Driver" />' >> $(DISTNAME).ppd
...
pm_to_blib : $(FIRST_MAKEFILE) $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', q[$(PM_FILTER)], '\''$(PERM_DIR)'\'')' -- \
	  lib/SMS/Send/UK/BTSmartMessaging.pm blib/lib/SMS/Send/UK/BTSmartMessaging.pm 
